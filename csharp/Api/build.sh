...
${nuget_cmd} install src/MarisIT.Api/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/MarisIT.Api.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/MarisIT.Api.dll \
-recurse:'src/MarisIT.Api/*.cs' \
-doc:bin/MarisIT.Api.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/MarisIT.Api.dll was created successfully"
fi
