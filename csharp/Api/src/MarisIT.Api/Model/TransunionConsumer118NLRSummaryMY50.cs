...
{
    /// <summary>
    /// TransunionConsumer118NLRSummaryMY50
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118NLRSummaryMY50 :  IEquatable<TransunionConsumer118NLRSummaryMY50>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118NLRSummaryMY50" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118NLRSummaryMY50 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118NLRSummaryMY50);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118NLRSummaryMY50 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118NLRSummaryMY50 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118NLRSummaryMY50 input)
        {
            if (input == null)
                return false;
