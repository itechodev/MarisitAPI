...
{
    /// <summary>
    /// XdsConsumer24MonthlyPaymentHeader
    /// </summary>
    [DataContract]
    public partial class XdsConsumer24MonthlyPaymentHeader :  IEquatable<XdsConsumer24MonthlyPaymentHeader>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XdsConsumer24MonthlyPaymentHeader" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XdsConsumer24MonthlyPaymentHeader {\n");
        ...
        {
            return this.Equals(input as XdsConsumer24MonthlyPaymentHeader);
        }

        /// <summary>
        /// Returns true if XdsConsumer24MonthlyPaymentHeader instances are equal
        /// </summary>
        /// <param name="input">Instance of XdsConsumer24MonthlyPaymentHeader to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XdsConsumer24MonthlyPaymentHeader input)
        {
            if (input == null)
                return false;
