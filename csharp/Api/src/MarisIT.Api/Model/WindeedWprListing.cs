...
namespace MarisIT.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WindeedWprListing :  IEquatable<WindeedWprListing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WindeedWprListing" /> class.
        /// </summary>
        ...
        /// <param name="detailsWithheld">detailsWithheld.</param>
        /// <param name="listingId">listingId.</param>
        public WindeedWprListing(string key = default(string), string propertyDescription = default(string), string address = default(string), string suburb = default(string), string size = default(string), int sizeInSqm = default(int), double distance = default(double), DateTime? salesDate = default(DateTime?), double salesPrice = default(double), WindeedWprCoordinate location = default(WindeedWprCoordinate), bool detailsWithheld = default(bool), string listingId = default(string))
        {
            this.Key = key;
            ...
            this.DetailsWithheld = detailsWithheld;
            this.ListingId = listingId;
        }
        ...
        /// <summary>
        /// Gets or Sets DetailsWithheld
        /// </summary>
        [DataMember(Name="detailsWithheld", EmitDefaultValue=false)]
        public bool DetailsWithheld { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WindeedWprListing {\n");
            ...
            sb.Append("  DetailsWithheld: ").Append(DetailsWithheld).Append("\n");
        ...
        {
            return this.Equals(input as WindeedWprListing);
        }

        /// <summary>
        /// Returns true if WindeedWprListing instances are equal
        /// </summary>
        /// <param name="input">Instance of WindeedWprListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WindeedWprListing input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DetailsWithheld == input.DetailsWithheld ||
                    (this.DetailsWithheld != null &&
                    this.DetailsWithheld.Equals(input.DetailsWithheld))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DetailsWithheld != null)
                    hashCode = hashCode * 59 + this.DetailsWithheld.GetHashCode();
