...
{
    /// <summary>
    /// WindeedSpiderPossibleMatch
    /// </summary>
    [DataContract]
    public partial class WindeedSpiderPossibleMatch :  IEquatable<WindeedSpiderPossibleMatch>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WindeedSpiderPossibleMatch" /> class.
        /// </summary>
        ...
        public WindeedSpiderPossibleMatch(int dbKey = default(int), string deedsOfficeName = default(string), string deedsOfficeNumber = default(string), string ciproName = default(string), int currentPropertyCount = default(int), int historicPropertyCount = default(int), WindeedSpiderPersonType? subjectType = default(WindeedSpiderPersonType?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WindeedSpiderPossibleMatch {\n");
        ...
        {
            return this.Equals(input as WindeedSpiderPossibleMatch);
        }

        /// <summary>
        /// Returns true if WindeedSpiderPossibleMatch instances are equal
        /// </summary>
        /// <param name="input">Instance of WindeedSpiderPossibleMatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WindeedSpiderPossibleMatch input)
        {
            if (input == null)
                return false;
