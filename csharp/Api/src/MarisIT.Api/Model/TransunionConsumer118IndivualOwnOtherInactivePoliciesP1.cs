...
{
    /// <summary>
    /// TransunionConsumer118IndivualOwnOtherInactivePoliciesP1
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118IndivualOwnOtherInactivePoliciesP1 :  IEquatable<TransunionConsumer118IndivualOwnOtherInactivePoliciesP1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118IndivualOwnOtherInactivePoliciesP1" /> class.
        /// </summary>
        ...
        public TransunionConsumer118IndivualOwnOtherInactivePoliciesP1(string requestIndicator = default(string), string ownOtherActivePolicyIndicator = default(string), string insurerName = default(string), string policyNumber = default(string), List<string> riskType = default(List<string>), string policyStatus = default(string), string policyInceptionDate = default(string), string policyCancellationDate = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118IndivualOwnOtherInactivePoliciesP1 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118IndivualOwnOtherInactivePoliciesP1);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118IndivualOwnOtherInactivePoliciesP1 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118IndivualOwnOtherInactivePoliciesP1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118IndivualOwnOtherInactivePoliciesP1 input)
        {
            if (input == null)
                return false;
