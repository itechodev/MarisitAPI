...
{
    /// <summary>
    /// TransunionConsumer118PaymentProfileP705
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118PaymentProfileP705 :  IEquatable<TransunionConsumer118PaymentProfileP705>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118PaymentProfileP705" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118PaymentProfileP705 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118PaymentProfileP705);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118PaymentProfileP705 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118PaymentProfileP705 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118PaymentProfileP705 input)
        {
            if (input == null)
                return false;
