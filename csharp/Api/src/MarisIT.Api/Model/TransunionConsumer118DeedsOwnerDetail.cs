...
{
    /// <summary>
    /// TransunionConsumer118DeedsOwnerDetail
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118DeedsOwnerDetail :  IEquatable<TransunionConsumer118DeedsOwnerDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118DeedsOwnerDetail" /> class.
        /// </summary>
        ...
        public TransunionConsumer118DeedsOwnerDetail(string multiBuyer = default(string), string multiBuyerID = default(string), string multiITNumber = default(string), string multiConsumerNumber = default(string), string multiStatDescription = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118DeedsOwnerDetail {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118DeedsOwnerDetail);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118DeedsOwnerDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118DeedsOwnerDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118DeedsOwnerDetail input)
        {
            if (input == null)
                return false;
