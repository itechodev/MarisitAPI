...
{
    /// <summary>
    /// TransunionCommercialConsumerBusinessEnquiry
    /// </summary>
    [DataContract]
    public partial class TransunionCommercialConsumerBusinessEnquiry :  IEquatable<TransunionCommercialConsumerBusinessEnquiry>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionCommercialConsumerBusinessEnquiry" /> class.
        /// </summary>
        ...
        public TransunionCommercialConsumerBusinessEnquiry(string majorProduct = default(string), string consumerNo = default(string), string enquiryDate = default(string), string subscriber = default(string), string contact = default(string), string type = default(string), string transType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionCommercialConsumerBusinessEnquiry {\n");
        ...
        {
            return this.Equals(input as TransunionCommercialConsumerBusinessEnquiry);
        }

        /// <summary>
        /// Returns true if TransunionCommercialConsumerBusinessEnquiry instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionCommercialConsumerBusinessEnquiry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionCommercialConsumerBusinessEnquiry input)
        {
            if (input == null)
                return false;
