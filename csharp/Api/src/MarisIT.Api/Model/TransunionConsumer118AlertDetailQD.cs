...
{
    /// <summary>
    /// TransunionConsumer118AlertDetailQD
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118AlertDetailQD :  IEquatable<TransunionConsumer118AlertDetailQD>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118AlertDetailQD" /> class.
        /// </summary>
        ...
        /// <param name="defaultTypeDescription">defaultTypeDescription.</param>
        /// <param name="amount">amount.</param>
        /// <param name="updatedDefaultType">updatedDefaultType.</param>
        /// <param name="updatedDefaultTypeDescription">updatedDefaultTypeDescription.</param>
        /// <param name="updatedAmount">updatedAmount.</param>
        /// <param name="subscriberReference">subscriberReference.</param>
        public TransunionConsumer118AlertDetailQD(int alertType = default(int), DateTime dateAlert = default(DateTime), string consumerName = default(string), string idNumber = default(string), int consumerNumber = default(int), string dateFlagged = default(string), string actionType = default(string), string subscriberNumber = default(string), string industryDescription = default(string), DateTime captureDate = default(DateTime), string defaultType = default(string), string defaultTypeDescription = default(string), string amount = default(string), string updatedDefaultType = default(string), string updatedDefaultTypeDescription = default(string), string updatedAmount = default(string), string subscriberReference = default(string))
        {
            ...
            this.Amount = amount;
            this.UpdatedDefaultType = updatedDefaultType;
            this.UpdatedDefaultTypeDescription = updatedDefaultTypeDescription;
        ...
        /// <summary>
        /// Gets or Sets DefaultTypeDescription
        /// </summary>
        [DataMember(Name="defaultTypeDescription", EmitDefaultValue=true)]
        ...
        /// <summary>
        /// Gets or Sets UpdatedDefaultType
        /// </summary>
        [DataMember(Name="updatedDefaultType", EmitDefaultValue=true)]
        public string UpdatedDefaultType { get; set; }

        /// <summary>
        /// Gets or Sets UpdatedDefaultTypeDescription
        /// </summary>
        [DataMember(Name="updatedDefaultTypeDescription", EmitDefaultValue=true)]
        public string UpdatedDefaultTypeDescription { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118AlertDetailQD {\n");
            ...
            sb.Append("  DefaultTypeDescription: ").Append(DefaultTypeDescription).Append("\n");
            sb.Append("  Amount: ").Append(Amount).Append("\n");
            sb.Append("  UpdatedDefaultType: ").Append(UpdatedDefaultType).Append("\n");
            sb.Append("  UpdatedDefaultTypeDescription: ").Append(UpdatedDefaultTypeDescription).Append("\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118AlertDetailQD);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118AlertDetailQD instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118AlertDetailQD to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118AlertDetailQD input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DefaultTypeDescription == input.DefaultTypeDescription ||
                    (this.DefaultTypeDescription != null &&
                    this.DefaultTypeDescription.Equals(input.DefaultTypeDescription))
                ) && 
                (
                ...
                (
                    this.UpdatedDefaultType == input.UpdatedDefaultType ||
                    (this.UpdatedDefaultType != null &&
                    this.UpdatedDefaultType.Equals(input.UpdatedDefaultType))
                ) && 
                (
                    this.UpdatedDefaultTypeDescription == input.UpdatedDefaultTypeDescription ||
                    (this.UpdatedDefaultTypeDescription != null &&
                    this.UpdatedDefaultTypeDescription.Equals(input.UpdatedDefaultTypeDescription))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DefaultTypeDescription != null)
                    hashCode = hashCode * 59 + this.DefaultTypeDescription.GetHashCode();
                if (this.Amount != null)
                    hashCode = hashCode * 59 + this.Amount.GetHashCode();
                if (this.UpdatedDefaultType != null)
                    hashCode = hashCode * 59 + this.UpdatedDefaultType.GetHashCode();
                if (this.UpdatedDefaultTypeDescription != null)
                    hashCode = hashCode * 59 + this.UpdatedDefaultTypeDescription.GetHashCode();
