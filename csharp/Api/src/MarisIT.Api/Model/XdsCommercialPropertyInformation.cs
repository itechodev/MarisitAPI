...
{
    /// <summary>
    /// XdsCommercialPropertyInformation
    /// </summary>
    [DataContract]
    public partial class XdsCommercialPropertyInformation :  IEquatable<XdsCommercialPropertyInformation>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XdsCommercialPropertyInformation" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XdsCommercialPropertyInformation {\n");
        ...
        {
            return this.Equals(input as XdsCommercialPropertyInformation);
        }

        /// <summary>
        /// Returns true if XdsCommercialPropertyInformation instances are equal
        /// </summary>
        /// <param name="input">Instance of XdsCommercialPropertyInformation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XdsCommercialPropertyInformation input)
        {
            if (input == null)
                return false;
