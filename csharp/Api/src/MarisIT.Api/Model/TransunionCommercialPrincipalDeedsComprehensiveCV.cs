...
{
    /// <summary>
    /// TransunionCommercialPrincipalDeedsComprehensiveCV
    /// </summary>
    [DataContract]
    public partial class TransunionCommercialPrincipalDeedsComprehensiveCV :  IEquatable<TransunionCommercialPrincipalDeedsComprehensiveCV>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionCommercialPrincipalDeedsComprehensiveCV" /> class.
        /// </summary>
        ...
        public TransunionCommercialPrincipalDeedsComprehensiveCV(string majorProduct = default(string), string date = default(string), string comment = default(string), string purchasePrice = default(string), string purchaseDate = default(string), string propertySize = default(string), string bondNumber = default(string), string bondHolder = default(string), string bondAmount = default(string), string bondDate = default(string), string dateOfBirthOrIDNumber = default(string), string erf = default(string), string farm = default(string), string propertyName = default(string), string schemeName = default(string), string schemeNumber = default(string), string portion = default(string), string title = default(string), string township = default(string), string deedsOffice = default(string), string multipleOwners = default(string), string share = default(string), string propertyType = default(string), string rowID = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionCommercialPrincipalDeedsComprehensiveCV {\n");
        ...
        {
            return this.Equals(input as TransunionCommercialPrincipalDeedsComprehensiveCV);
        }

        /// <summary>
        /// Returns true if TransunionCommercialPrincipalDeedsComprehensiveCV instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionCommercialPrincipalDeedsComprehensiveCV to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionCommercialPrincipalDeedsComprehensiveCV input)
        {
            if (input == null)
                return false;
