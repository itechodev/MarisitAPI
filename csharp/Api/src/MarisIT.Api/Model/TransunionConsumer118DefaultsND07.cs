...
{
    /// <summary>
    /// TransunionConsumer118DefaultsND07
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118DefaultsND07 :  IEquatable<TransunionConsumer118DefaultsND07>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118DefaultsND07" /> class.
        /// </summary>
        ...
        public TransunionConsumer118DefaultsND07(string recordSeq = default(string), string part = default(string), string partSeq = default(string), string consumerNo = default(string), string contactName = default(string), string telephoneCode = default(string), string telephoneNo = default(string), string informationDate = default(string), string supplierName = default(string), string accountNo = default(string), string subAccount = default(string), string branch = default(string), string defaultTypeCode = default(string), string defaultType = default(string), string defaultAmount = default(string), string writtenOffDate = default(string), string surname = default(string), string forename1 = default(string), string forename2 = default(string), string forename3 = default(string), string identityNo = default(string), string dateOfBirth = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string suburb = default(string), string city = default(string), string postcode = default(string), string remarks = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118DefaultsND07 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118DefaultsND07);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118DefaultsND07 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118DefaultsND07 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118DefaultsND07 input)
        {
            if (input == null)
                return false;
