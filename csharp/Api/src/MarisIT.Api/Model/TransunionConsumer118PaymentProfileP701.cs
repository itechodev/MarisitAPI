...
{
    /// <summary>
    /// TransunionConsumer118PaymentProfileP701
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118PaymentProfileP701 :  IEquatable<TransunionConsumer118PaymentProfileP701>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118PaymentProfileP701" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118PaymentProfileP701 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118PaymentProfileP701);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118PaymentProfileP701 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118PaymentProfileP701 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118PaymentProfileP701 input)
        {
            if (input == null)
                return false;
