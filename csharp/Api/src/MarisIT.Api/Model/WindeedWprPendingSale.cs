...
{
    /// <summary>
    /// WindeedWprPendingSale
    /// </summary>
    [DataContract]
    public partial class WindeedWprPendingSale :  IEquatable<WindeedWprPendingSale>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WindeedWprPendingSale" /> class.
        /// </summary>
        ...
        public WindeedWprPendingSale(string key = default(string), string propertyDescription = default(string), string address = default(string), string suburb = default(string), string size = default(string), int sizeInSqm = default(int), double distance = default(double), double salesPrice = default(double), WindeedWprCoordinate location = default(WindeedWprCoordinate))
        {
            this.Key = key;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WindeedWprPendingSale {\n");
        ...
        {
            return this.Equals(input as WindeedWprPendingSale);
        }

        /// <summary>
        /// Returns true if WindeedWprPendingSale instances are equal
        /// </summary>
        /// <param name="input">Instance of WindeedWprPendingSale to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WindeedWprPendingSale input)
        {
            if (input == null)
                return false;
