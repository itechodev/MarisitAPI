...
{
    /// <summary>
    /// TransunionCommercialDefault
    /// </summary>
    [DataContract]
    public partial class TransunionCommercialDefault :  IEquatable<TransunionCommercialDefault>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionCommercialDefault" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionCommercialDefault {\n");
        ...
        {
            return this.Equals(input as TransunionCommercialDefault);
        }

        /// <summary>
        /// Returns true if TransunionCommercialDefault instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionCommercialDefault to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionCommercialDefault input)
        {
            if (input == null)
                return false;
