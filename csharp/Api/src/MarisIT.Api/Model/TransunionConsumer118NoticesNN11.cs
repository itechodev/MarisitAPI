...
{
    /// <summary>
    /// TransunionConsumer118NoticesNN11
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118NoticesNN11 :  IEquatable<TransunionConsumer118NoticesNN11>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118NoticesNN11" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118NoticesNN11 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118NoticesNN11);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118NoticesNN11 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118NoticesNN11 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118NoticesNN11 input)
        {
            if (input == null)
                return false;
