...
{
    /// <summary>
    /// TransunionConsumer118EmpiricaEM07
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118EmpiricaEM07 :  IEquatable<TransunionConsumer118EmpiricaEM07>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118EmpiricaEM07" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118EmpiricaEM07 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118EmpiricaEM07);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118EmpiricaEM07 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118EmpiricaEM07 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118EmpiricaEM07 input)
        {
            if (input == null)
                return false;
