...
{
    /// <summary>
    /// TransunionConsumer118ExtendedNLRHistory
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118ExtendedNLRHistory :  IEquatable<TransunionConsumer118ExtendedNLRHistory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118ExtendedNLRHistory" /> class.
        /// </summary>
        ...
        public TransunionConsumer118ExtendedNLRHistory(string openingBalance = default(string), string currentBalance = default(string), string overDueAmount = default(string), string installmentAmount = default(string), string transactionDate = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118ExtendedNLRHistory {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118ExtendedNLRHistory);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118ExtendedNLRHistory instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118ExtendedNLRHistory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118ExtendedNLRHistory input)
        {
            if (input == null)
                return false;
