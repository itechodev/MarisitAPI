...
{
    /// <summary>
    /// WindeedSpiderProperty
    /// </summary>
    [DataContract]
    public partial class WindeedSpiderProperty :  IEquatable<WindeedSpiderProperty>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WindeedSpiderProperty" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WindeedSpiderProperty {\n");
        ...
        {
            return this.Equals(input as WindeedSpiderProperty);
        }

        /// <summary>
        /// Returns true if WindeedSpiderProperty instances are equal
        /// </summary>
        /// <param name="input">Instance of WindeedSpiderProperty to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WindeedSpiderProperty input)
        {
            if (input == null)
                return false;
