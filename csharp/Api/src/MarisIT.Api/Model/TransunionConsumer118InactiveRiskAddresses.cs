...
{
    /// <summary>
    /// TransunionConsumer118InactiveRiskAddresses
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118InactiveRiskAddresses :  IEquatable<TransunionConsumer118InactiveRiskAddresses>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118InactiveRiskAddresses" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118InactiveRiskAddresses {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118InactiveRiskAddresses);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118InactiveRiskAddresses instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118InactiveRiskAddresses to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118InactiveRiskAddresses input)
        {
            if (input == null)
                return false;
