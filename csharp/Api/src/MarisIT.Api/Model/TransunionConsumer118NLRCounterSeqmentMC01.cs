...
{
    /// <summary>
    /// TransunionConsumer118NLRCounterSeqmentMC01
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118NLRCounterSeqmentMC01 :  IEquatable<TransunionConsumer118NLRCounterSeqmentMC01>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118NLRCounterSeqmentMC01" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118NLRCounterSeqmentMC01 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118NLRCounterSeqmentMC01);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118NLRCounterSeqmentMC01 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118NLRCounterSeqmentMC01 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118NLRCounterSeqmentMC01 input)
        {
            if (input == null)
                return false;
