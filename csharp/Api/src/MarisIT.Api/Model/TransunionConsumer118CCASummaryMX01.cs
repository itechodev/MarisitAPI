...
{
    /// <summary>
    /// TransunionConsumer118CCASummaryMX01
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118CCASummaryMX01 :  IEquatable<TransunionConsumer118CCASummaryMX01>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118CCASummaryMX01" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118CCASummaryMX01 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118CCASummaryMX01);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118CCASummaryMX01 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118CCASummaryMX01 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118CCASummaryMX01 input)
        {
            if (input == null)
                return false;
