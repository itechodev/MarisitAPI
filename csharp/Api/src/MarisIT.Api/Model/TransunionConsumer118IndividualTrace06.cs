...
{
    /// <summary>
    /// TransunionConsumer118IndividualTrace06
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118IndividualTrace06 :  IEquatable<TransunionConsumer118IndividualTrace06>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118IndividualTrace06" /> class.
        /// </summary>
        ...
        public TransunionConsumer118IndividualTrace06(string consumerNo = default(string), string surname = default(string), string forename1 = default(string), string forename2 = default(string), string dateOfBirth = default(string), string identityNumber1 = default(string), string identityNumber2 = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string telephoneNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118IndividualTrace06 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118IndividualTrace06);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118IndividualTrace06 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118IndividualTrace06 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118IndividualTrace06 input)
        {
            if (input == null)
                return false;
