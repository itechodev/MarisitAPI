...
{
    /// <summary>
    /// WindeedWprTitleDeedOwner
    /// </summary>
    [DataContract]
    public partial class WindeedWprTitleDeedOwner :  IEquatable<WindeedWprTitleDeedOwner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WindeedWprTitleDeedOwner" /> class.
        /// </summary>
        ...
        public WindeedWprTitleDeedOwner(string documentNumber = default(string), string microfilmNumber = default(string), string typeCode = default(string), string typeDescription = default(string), double? amount = default(double?), string purchaseType = default(string), bool multiOwner = default(bool), bool multiProperty = default(bool), DateTime? purchaseDate = default(DateTime?), DateTime? registrationDate = default(DateTime?), double? share = default(double?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WindeedWprTitleDeedOwner {\n");
        ...
        {
            return this.Equals(input as WindeedWprTitleDeedOwner);
        }

        /// <summary>
        /// Returns true if WindeedWprTitleDeedOwner instances are equal
        /// </summary>
        /// <param name="input">Instance of WindeedWprTitleDeedOwner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WindeedWprTitleDeedOwner input)
        {
            if (input == null)
                return false;
