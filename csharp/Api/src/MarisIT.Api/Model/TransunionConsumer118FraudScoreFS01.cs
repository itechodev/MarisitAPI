...
{
    /// <summary>
    /// TransunionConsumer118FraudScoreFS01
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118FraudScoreFS01 :  IEquatable<TransunionConsumer118FraudScoreFS01>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118FraudScoreFS01" /> class.
        /// </summary>
        ...
        public TransunionConsumer118FraudScoreFS01(string recordSequence = default(string), string part = default(string), string partSequence = default(string), string consumerNo = default(string), string rating = default(string), string ratingDescription = default(string), List<string> reasonCode = default(List<string>), List<string> reasonDescription = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118FraudScoreFS01 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118FraudScoreFS01);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118FraudScoreFS01 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118FraudScoreFS01 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118FraudScoreFS01 input)
        {
            if (input == null)
                return false;
