...
{
    /// <summary>
    /// TransunionConsumer118TUVehicleInsuranceClaimsRecordedVJ
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118TUVehicleInsuranceClaimsRecordedVJ :  IEquatable<TransunionConsumer118TUVehicleInsuranceClaimsRecordedVJ>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118TUVehicleInsuranceClaimsRecordedVJ" /> class.
        /// </summary>
        ...
        /// <param name="dateOfClaim">dateOfClaim.</param>
        /// <param name="claimType">claimType.</param>
        public TransunionConsumer118TUVehicleInsuranceClaimsRecordedVJ(string recordDescription = default(string), string insuranceCompanyName = default(string), string policyNumber = default(string), string dateOfClaim = default(string), string claimType = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets DateOfClaim
        /// </summary>
        [DataMember(Name="dateOfClaim", EmitDefaultValue=true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118TUVehicleInsuranceClaimsRecordedVJ {\n");
            ...
            sb.Append("  DateOfClaim: ").Append(DateOfClaim).Append("\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118TUVehicleInsuranceClaimsRecordedVJ);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118TUVehicleInsuranceClaimsRecordedVJ instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118TUVehicleInsuranceClaimsRecordedVJ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118TUVehicleInsuranceClaimsRecordedVJ input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DateOfClaim == input.DateOfClaim ||
                    (this.DateOfClaim != null &&
                    this.DateOfClaim.Equals(input.DateOfClaim))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DateOfClaim != null)
                    hashCode = hashCode * 59 + this.DateOfClaim.GetHashCode();
