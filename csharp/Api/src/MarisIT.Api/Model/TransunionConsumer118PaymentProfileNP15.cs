...
{
    /// <summary>
    /// TransunionConsumer118PaymentProfileNP15
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118PaymentProfileNP15 :  IEquatable<TransunionConsumer118PaymentProfileNP15>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118PaymentProfileNP15" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118PaymentProfileNP15 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118PaymentProfileNP15);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118PaymentProfileNP15 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118PaymentProfileNP15 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118PaymentProfileNP15 input)
        {
            if (input == null)
                return false;
