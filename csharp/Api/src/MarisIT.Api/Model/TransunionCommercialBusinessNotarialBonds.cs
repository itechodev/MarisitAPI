...
{
    /// <summary>
    /// TransunionCommercialBusinessNotarialBonds
    /// </summary>
    [DataContract]
    public partial class TransunionCommercialBusinessNotarialBonds :  IEquatable<TransunionCommercialBusinessNotarialBonds>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionCommercialBusinessNotarialBonds" /> class.
        /// </summary>
        ...
        public TransunionCommercialBusinessNotarialBonds(string majorProduct = default(string), string deedsOffice = default(string), string multipleOwners = default(string), string bondRegDate = default(string), string bondNumber = default(string), string bondAmount = default(string), string microfilemRef = default(string), string bondType = default(string), string bondOwner = default(string), string ownerID = default(string), string ownerType = default(string), string bondPercentage = default(string), List<string> heldOver = default(List<string>), string hoAboveThreshold = default(string), string parentChildInd = default(string), string message = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionCommercialBusinessNotarialBonds {\n");
        ...
        {
            return this.Equals(input as TransunionCommercialBusinessNotarialBonds);
        }

        /// <summary>
        /// Returns true if TransunionCommercialBusinessNotarialBonds instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionCommercialBusinessNotarialBonds to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionCommercialBusinessNotarialBonds input)
        {
            if (input == null)
                return false;
