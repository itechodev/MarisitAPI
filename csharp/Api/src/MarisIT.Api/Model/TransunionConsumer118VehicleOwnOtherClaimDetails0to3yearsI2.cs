...
{
    /// <summary>
    /// TransunionConsumer118VehicleOwnOtherClaimDetails0to3yearsI2
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118VehicleOwnOtherClaimDetails0to3yearsI2 :  IEquatable<TransunionConsumer118VehicleOwnOtherClaimDetails0to3yearsI2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118VehicleOwnOtherClaimDetails0to3yearsI2" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118VehicleOwnOtherClaimDetails0to3yearsI2 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118VehicleOwnOtherClaimDetails0to3yearsI2);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118VehicleOwnOtherClaimDetails0to3yearsI2 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118VehicleOwnOtherClaimDetails0to3yearsI2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118VehicleOwnOtherClaimDetails0to3yearsI2 input)
        {
            if (input == null)
                return false;
