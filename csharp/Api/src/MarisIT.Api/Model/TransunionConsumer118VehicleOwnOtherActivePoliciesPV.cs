...
{
    /// <summary>
    /// TransunionConsumer118VehicleOwnOtherActivePoliciesPV
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118VehicleOwnOtherActivePoliciesPV :  IEquatable<TransunionConsumer118VehicleOwnOtherActivePoliciesPV>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118VehicleOwnOtherActivePoliciesPV" /> class.
        /// </summary>
        ...
        /// <param name="activeVehicles">activeVehicles.</param>
        public TransunionConsumer118VehicleOwnOtherActivePoliciesPV(string requestIndicator = default(string), string ownOtherActivePolicyIndicator = default(string), string insurerName = default(string), string policyNumber = default(string), List<string> riskType = default(List<string>), string policyStatus = default(string), string policyInceptionDate = default(string), string policyCancellationDate = default(string), List<TransunionConsumer118ActiveVehicles> activeVehicles = default(List<TransunionConsumer118ActiveVehicles>))
        {
        ...
        /// <summary>
        /// Gets or Sets ActiveVehicles
        /// </summary>
        [DataMember(Name="activeVehicles", EmitDefaultValue=true)]
        public List<TransunionConsumer118ActiveVehicles> ActiveVehicles { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118VehicleOwnOtherActivePoliciesPV {\n");
            ...
            sb.Append("  ActiveVehicles: ").Append(ActiveVehicles).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransunionConsumer118VehicleOwnOtherActivePoliciesPV);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118VehicleOwnOtherActivePoliciesPV instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118VehicleOwnOtherActivePoliciesPV to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118VehicleOwnOtherActivePoliciesPV input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ActiveVehicles == input.ActiveVehicles ||
                    this.ActiveVehicles != null &&
                    input.ActiveVehicles != null &&
                    this.ActiveVehicles.SequenceEqual(input.ActiveVehicles)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ActiveVehicles != null)
                    hashCode = hashCode * 59 + this.ActiveVehicles.GetHashCode();
                return hashCode;
            }
        }
