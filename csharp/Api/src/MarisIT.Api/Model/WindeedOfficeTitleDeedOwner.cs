...
{
    /// <summary>
    /// WindeedOfficeTitleDeedOwner
    /// </summary>
    [DataContract]
    public partial class WindeedOfficeTitleDeedOwner :  IEquatable<WindeedOfficeTitleDeedOwner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WindeedOfficeTitleDeedOwner" /> class.
        /// </summary>
        ...
        public WindeedOfficeTitleDeedOwner(string documentNumber = default(string), string microfilmNumber = default(string), string typeCode = default(string), string typeDescription = default(string), string amount = default(string), string purchaseType = default(string), bool multiOwner = default(bool), bool multiProperty = default(bool), DateTime? purchaseDate = default(DateTime?), DateTime? registrationDate = default(DateTime?), string share = default(string), string dbKey = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WindeedOfficeTitleDeedOwner {\n");
        ...
        {
            return this.Equals(input as WindeedOfficeTitleDeedOwner);
        }

        /// <summary>
        /// Returns true if WindeedOfficeTitleDeedOwner instances are equal
        /// </summary>
        /// <param name="input">Instance of WindeedOfficeTitleDeedOwner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WindeedOfficeTitleDeedOwner input)
        {
            if (input == null)
                return false;
