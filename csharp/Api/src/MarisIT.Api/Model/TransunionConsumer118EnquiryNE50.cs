...
{
    /// <summary>
    /// TransunionConsumer118EnquiryNE50
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118EnquiryNE50 :  IEquatable<TransunionConsumer118EnquiryNE50>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118EnquiryNE50" /> class.
        /// </summary>
        ...
        public TransunionConsumer118EnquiryNE50(string consumerNo = default(string), string dateOfEnquiry = default(string), string subscriber = default(string), string contact = default(string), string enquiryTypeCode = default(string), string enquiryTypeDescription = default(string), string ownAccount = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118EnquiryNE50 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118EnquiryNE50);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118EnquiryNE50 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118EnquiryNE50 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118EnquiryNE50 input)
        {
            if (input == null)
                return false;
