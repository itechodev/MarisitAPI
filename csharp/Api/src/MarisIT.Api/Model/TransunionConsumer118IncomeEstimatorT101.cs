...
{
    /// <summary>
    /// TransunionConsumer118IncomeEstimatorT101
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118IncomeEstimatorT101 :  IEquatable<TransunionConsumer118IncomeEstimatorT101>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118IncomeEstimatorT101" /> class.
        /// </summary>
        /// <param name="consumerNo">consumerNo.</param>
        /// <param name="predictedIncome">predictedIncome.</param>
        public TransunionConsumer118IncomeEstimatorT101(string consumerNo = default(string), string predictedIncome = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118IncomeEstimatorT101 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118IncomeEstimatorT101);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118IncomeEstimatorT101 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118IncomeEstimatorT101 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118IncomeEstimatorT101 input)
        {
            if (input == null)
                return false;
