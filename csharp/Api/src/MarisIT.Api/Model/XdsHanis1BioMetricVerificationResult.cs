...
{
    /// <summary>
    /// XdsHanis1BioMetricVerificationResult
    /// </summary>
    [DataContract]
    public partial class XdsHanis1BioMetricVerificationResult :  IEquatable<XdsHanis1BioMetricVerificationResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XdsHanis1BioMetricVerificationResult" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XdsHanis1BioMetricVerificationResult {\n");
        ...
        {
            return this.Equals(input as XdsHanis1BioMetricVerificationResult);
        }

        /// <summary>
        /// Returns true if XdsHanis1BioMetricVerificationResult instances are equal
        /// </summary>
        /// <param name="input">Instance of XdsHanis1BioMetricVerificationResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XdsHanis1BioMetricVerificationResult input)
        {
            if (input == null)
                return false;
