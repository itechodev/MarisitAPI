...
{
    /// <summary>
    /// TransunionConsumer118AlertDetailQM
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118AlertDetailQM :  IEquatable<TransunionConsumer118AlertDetailQM>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118AlertDetailQM" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118AlertDetailQM {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118AlertDetailQM);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118AlertDetailQM instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118AlertDetailQM to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118AlertDetailQM input)
        {
            if (input == null)
                return false;
