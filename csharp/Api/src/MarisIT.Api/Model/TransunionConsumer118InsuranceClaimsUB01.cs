...
{
    /// <summary>
    /// TransunionConsumer118InsuranceClaimsUB01
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118InsuranceClaimsUB01 :  IEquatable<TransunionConsumer118InsuranceClaimsUB01>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118InsuranceClaimsUB01" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118InsuranceClaimsUB01 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118InsuranceClaimsUB01);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118InsuranceClaimsUB01 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118InsuranceClaimsUB01 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118InsuranceClaimsUB01 input)
        {
            if (input == null)
                return false;
