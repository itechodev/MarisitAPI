...
{
    /// <summary>
    /// TransunionConsumer118DeedsMultipleBond
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118DeedsMultipleBond :  IEquatable<TransunionConsumer118DeedsMultipleBond>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118DeedsMultipleBond" /> class.
        /// </summary>
        ...
        public TransunionConsumer118DeedsMultipleBond(string majorProduct = default(string), string actionDate = default(string), string comment = default(string), string bondNumber = default(string), string bondHolder = default(string), string bondAmount = default(string), string bondDate = default(string), string bondBuyerID = default(string), string bondBuyerName = default(string), string rowID = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118DeedsMultipleBond {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118DeedsMultipleBond);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118DeedsMultipleBond instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118DeedsMultipleBond to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118DeedsMultipleBond input)
        {
            if (input == null)
                return false;
