...
{
    /// <summary>
    /// XdsConsumerSequestration
    /// </summary>
    [DataContract]
    public partial class XdsConsumerSequestration :  IEquatable<XdsConsumerSequestration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XdsConsumerSequestration" /> class.
        /// </summary>
        ...
        public XdsConsumerSequestration(string attorneyName = default(string), string caseFilingDate = default(string), string caseNumber = default(string), string caseReason = default(string), string caseType = default(string), string comments = default(string), string courtName = default(string), string displayText = default(string), string disputeAmt = default(string), string lastUpdatedDate = default(string), string plaintiffName = default(string), string telephoneNo = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XdsConsumerSequestration {\n");
        ...
        {
            return this.Equals(input as XdsConsumerSequestration);
        }

        /// <summary>
        /// Returns true if XdsConsumerSequestration instances are equal
        /// </summary>
        /// <param name="input">Instance of XdsConsumerSequestration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XdsConsumerSequestration input)
        {
            if (input == null)
                return false;
