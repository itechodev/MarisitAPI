...
{
    /// <summary>
    /// TransunionCommercialBusinessDeedsDI
    /// </summary>
    [DataContract]
    public partial class TransunionCommercialBusinessDeedsDI :  IEquatable<TransunionCommercialBusinessDeedsDI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionCommercialBusinessDeedsDI" /> class.
        /// </summary>
        ...
        public TransunionCommercialBusinessDeedsDI(string majorProduct = default(string), string date = default(string), string comment = default(string), string purchasePrice = default(string), string purchaseDate = default(string), string propertySize = default(string), string bondNumber = default(string), string bondHolder = default(string), string bondAmount = default(string), string bondDate = default(string), string dateOfBirthOrIDNumber = default(string), string erf = default(string), string farm = default(string), string buyerName = default(string), string portion = default(string), string title = default(string), string township = default(string), string deedsOffice = default(string), string rowID = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionCommercialBusinessDeedsDI {\n");
        ...
        {
            return this.Equals(input as TransunionCommercialBusinessDeedsDI);
        }

        /// <summary>
        /// Returns true if TransunionCommercialBusinessDeedsDI instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionCommercialBusinessDeedsDI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionCommercialBusinessDeedsDI input)
        {
            if (input == null)
                return false;
