...
{
    /// <summary>
    /// TransunionConsumer118AlertDetailQJ
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118AlertDetailQJ :  IEquatable<TransunionConsumer118AlertDetailQJ>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118AlertDetailQJ" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118AlertDetailQJ {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118AlertDetailQJ);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118AlertDetailQJ instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118AlertDetailQJ to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118AlertDetailQJ input)
        {
            if (input == null)
                return false;
