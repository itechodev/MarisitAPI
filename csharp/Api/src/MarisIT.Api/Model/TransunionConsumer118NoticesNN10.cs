...
{
    /// <summary>
    /// TransunionConsumer118NoticesNN10
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118NoticesNN10 :  IEquatable<TransunionConsumer118NoticesNN10>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118NoticesNN10" /> class.
        /// </summary>
        ...
        public TransunionConsumer118NoticesNN10(string recordSeq = default(string), string part = default(string), string partSeq = default(string), string consumerNo = default(string), string noticeDate = default(string), string amount = default(string), string applicant = default(string), string noticeTypeCode = default(string), string noticeType = default(string), string captureDate = default(string), string surname1 = default(string), string surname2 = default(string), string forename1 = default(string), string forename2 = default(string), string forename3 = default(string), string title = default(string), string defendant = default(string), string address = default(string), string suburb = default(string), string tradingAsName = default(string), string dateOfBirth = default(string), string idNumber = default(string), string courtTypeCode = default(string), string courtTypeDesc = default(string), string courtNameCode = default(string), string courtNameDesc = default(string), string caseNo = default(string), string bondPercent = default(string), string defendantMagisterialDistrict = default(string), string remarks = default(string), string attorneyName = default(string), string attorneyReference = default(string), string contactTelephoneNo = default(string), string comment1 = default(string), string comment2 = default(string), string comment3 = default(string), string comment4 = default(string), string comment5 = default(string), string comment6 = default(string), string comment7 = default(string), string comment8 = default(string), string comment9 = default(string), string comment10 = default(string), string administrationMonthlyAmount = default(string), string administrationNumberOfMonths = default(string), string administrationStartDate = default(string))
        {
            ...
            this.AdministrationStartDate = administrationStartDate;
            this.RecordSeq = recordSeq;
            this.Part = part;
            this.PartSeq = partSeq;
            this.ConsumerNo = consumerNo;
        ...
        /// <summary>
        /// Gets or Sets AdministrationStartDate
        /// </summary>
        [DataMember(Name="administrationStartDate", EmitDefaultValue=true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118NoticesNN10 {\n");
            ...
            sb.Append("  AdministrationStartDate: ").Append(AdministrationStartDate).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransunionConsumer118NoticesNN10);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118NoticesNN10 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118NoticesNN10 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118NoticesNN10 input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AdministrationStartDate == input.AdministrationStartDate ||
                    (this.AdministrationStartDate != null &&
                    this.AdministrationStartDate.Equals(input.AdministrationStartDate))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AdministrationStartDate != null)
                    hashCode = hashCode * 59 + this.AdministrationStartDate.GetHashCode();
                return hashCode;
            }
        }
