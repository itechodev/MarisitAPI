...
{
    /// <summary>
    /// TransunionConsumer118VehicleOwnOtherInactivePoliciesP2
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118VehicleOwnOtherInactivePoliciesP2 :  IEquatable<TransunionConsumer118VehicleOwnOtherInactivePoliciesP2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118VehicleOwnOtherInactivePoliciesP2" /> class.
        /// </summary>
        ...
        /// <param name="inactiveVehicles">inactiveVehicles.</param>
        public TransunionConsumer118VehicleOwnOtherInactivePoliciesP2(string requestIndicator = default(string), string ownOtherActivePolicyIndicator = default(string), string insurerName = default(string), string policyNumber = default(string), List<string> riskType = default(List<string>), string policyStatus = default(string), string policyInceptionDate = default(string), string policyCancellationDate = default(string), List<TransunionConsumer118InactiveVehicles> inactiveVehicles = default(List<TransunionConsumer118InactiveVehicles>))
        {
        ...
        /// <summary>
        /// Gets or Sets InactiveVehicles
        /// </summary>
        [DataMember(Name="inactiveVehicles", EmitDefaultValue=true)]
        public List<TransunionConsumer118InactiveVehicles> InactiveVehicles { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118VehicleOwnOtherInactivePoliciesP2 {\n");
            ...
            sb.Append("  InactiveVehicles: ").Append(InactiveVehicles).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransunionConsumer118VehicleOwnOtherInactivePoliciesP2);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118VehicleOwnOtherInactivePoliciesP2 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118VehicleOwnOtherInactivePoliciesP2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118VehicleOwnOtherInactivePoliciesP2 input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.InactiveVehicles == input.InactiveVehicles ||
                    this.InactiveVehicles != null &&
                    input.InactiveVehicles != null &&
                    this.InactiveVehicles.SequenceEqual(input.InactiveVehicles)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InactiveVehicles != null)
                    hashCode = hashCode * 59 + this.InactiveVehicles.GetHashCode();
                return hashCode;
            }
        }
