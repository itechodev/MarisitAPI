...
{
    /// <summary>
    /// TransunionCommercialNotarialBond
    /// </summary>
    [DataContract]
    public partial class TransunionCommercialNotarialBond :  IEquatable<TransunionCommercialNotarialBond>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionCommercialNotarialBond" /> class.
        /// </summary>
        ...
        public TransunionCommercialNotarialBond(string majorProduct = default(string), string numberFound = default(string), string bondDate = default(string), string mortgagor = default(string), string tradeStyle = default(string), string address = default(string), string suburb = default(string), string city = default(string), string country = default(string), string postCode = default(string), string bondNumber = default(string), string bondAmount = default(string), string bondPercent = default(string), string bondDistrict = default(string), string mortgagee = default(string), string dateCancelled = default(string), string message = default(string), string serialNumber = default(string), string mortgagorDistrict = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionCommercialNotarialBond {\n");
        ...
        {
            return this.Equals(input as TransunionCommercialNotarialBond);
        }

        /// <summary>
        /// Returns true if TransunionCommercialNotarialBond instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionCommercialNotarialBond to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionCommercialNotarialBond input)
        {
            if (input == null)
                return false;
