...
{
    /// <summary>
    /// TransunionCommercialConsumerInfoNO04
    /// </summary>
    [DataContract]
    public partial class TransunionCommercialConsumerInfoNO04 :  IEquatable<TransunionCommercialConsumerInfoNO04>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionCommercialConsumerInfoNO04" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionCommercialConsumerInfoNO04 {\n");
        ...
        {
            return this.Equals(input as TransunionCommercialConsumerInfoNO04);
        }

        /// <summary>
        /// Returns true if TransunionCommercialConsumerInfoNO04 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionCommercialConsumerInfoNO04 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionCommercialConsumerInfoNO04 input)
        {
            if (input == null)
                return false;
