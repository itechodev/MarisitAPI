...
{
    /// <summary>
    /// TransunionConsumer118AlertDetailQP
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118AlertDetailQP :  IEquatable<TransunionConsumer118AlertDetailQP>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118AlertDetailQP" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118AlertDetailQP {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118AlertDetailQP);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118AlertDetailQP instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118AlertDetailQP to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118AlertDetailQP input)
        {
            if (input == null)
                return false;
