...
{
    /// <summary>
    /// TransunionConsumer118RiskAddressOwnOtherClaimDetails0to3yearsI3
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118RiskAddressOwnOtherClaimDetails0to3yearsI3 :  IEquatable<TransunionConsumer118RiskAddressOwnOtherClaimDetails0to3yearsI3>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118RiskAddressOwnOtherClaimDetails0to3yearsI3" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118RiskAddressOwnOtherClaimDetails0to3yearsI3 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118RiskAddressOwnOtherClaimDetails0to3yearsI3);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118RiskAddressOwnOtherClaimDetails0to3yearsI3 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118RiskAddressOwnOtherClaimDetails0to3yearsI3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118RiskAddressOwnOtherClaimDetails0to3yearsI3 input)
        {
            if (input == null)
                return false;
