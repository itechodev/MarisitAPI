...
{
    /// <summary>
    /// TransunionCommercialBusinessDeedsComprehensivePB
    /// </summary>
    [DataContract]
    public partial class TransunionCommercialBusinessDeedsComprehensivePB :  IEquatable<TransunionCommercialBusinessDeedsComprehensivePB>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionCommercialBusinessDeedsComprehensivePB" /> class.
        /// </summary>
        ...
        public TransunionCommercialBusinessDeedsComprehensivePB(string majorProduct = default(string), string date = default(string), string comment = default(string), string purchasePrice = default(string), string purchaseDate = default(string), string propertySize = default(string), string bondNumber = default(string), string bondHolder = default(string), string bondAmount = default(string), string bondDate = default(string), string registrationNumber = default(string), string erf = default(string), string farm = default(string), string propertyName = default(string), string portion = default(string), string title = default(string), string township = default(string), string deedsOffice = default(string), string rowID = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionCommercialBusinessDeedsComprehensivePB {\n");
        ...
        {
            return this.Equals(input as TransunionCommercialBusinessDeedsComprehensivePB);
        }

        /// <summary>
        /// Returns true if TransunionCommercialBusinessDeedsComprehensivePB instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionCommercialBusinessDeedsComprehensivePB to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionCommercialBusinessDeedsComprehensivePB input)
        {
            if (input == null)
                return false;
