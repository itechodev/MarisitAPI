...
{
    /// <summary>
    /// TransunionCommercialBankHistory
    /// </summary>
    [DataContract]
    public partial class TransunionCommercialBankHistory :  IEquatable<TransunionCommercialBankHistory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionCommercialBankHistory" /> class.
        /// </summary>
        ...
        public TransunionCommercialBankHistory(string majorProduct = default(string), string accountNo = default(string), string bankName = default(string), string branch = default(string), string bankCode = default(string), string bankCodeDesc = default(string), List<string> comment = default(List<string>), string amount = default(string), string startDate = default(string), string terms = default(string), string date = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionCommercialBankHistory {\n");
        ...
        {
            return this.Equals(input as TransunionCommercialBankHistory);
        }

        /// <summary>
        /// Returns true if TransunionCommercialBankHistory instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionCommercialBankHistory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionCommercialBankHistory input)
        {
            if (input == null)
                return false;
