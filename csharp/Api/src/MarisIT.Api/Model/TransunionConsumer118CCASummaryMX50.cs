...
{
    /// <summary>
    /// TransunionConsumer118CCASummaryMX50
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118CCASummaryMX50 :  IEquatable<TransunionConsumer118CCASummaryMX50>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118CCASummaryMX50" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118CCASummaryMX50 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118CCASummaryMX50);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118CCASummaryMX50 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118CCASummaryMX50 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118CCASummaryMX50 input)
        {
            if (input == null)
                return false;
