...
{
    /// <summary>
    /// TransunionConsumer118AlertDetailQV
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118AlertDetailQV :  IEquatable<TransunionConsumer118AlertDetailQV>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118AlertDetailQV" /> class.
        /// </summary>
        ...
        public TransunionConsumer118AlertDetailQV(int alertType = default(int), DateTime dateAlert = default(DateTime), string consumerName = default(string), string idNumber = default(string), int consumerNumber = default(int), string dateFlagged = default(string), string actionType = default(string), string subscriberNumber = default(string), string subscriberReference = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118AlertDetailQV {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118AlertDetailQV);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118AlertDetailQV instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118AlertDetailQV to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118AlertDetailQV input)
        {
            if (input == null)
                return false;
