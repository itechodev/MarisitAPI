...
{
    /// <summary>
    /// TransunionConsumer118PaymentProfileP704
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118PaymentProfileP704 :  IEquatable<TransunionConsumer118PaymentProfileP704>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118PaymentProfileP704" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118PaymentProfileP704 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118PaymentProfileP704);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118PaymentProfileP704 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118PaymentProfileP704 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118PaymentProfileP704 input)
        {
            if (input == null)
                return false;
