...
{
    /// <summary>
    /// XdsBusinessEnquiryHistory
    /// </summary>
    [DataContract]
    public partial class XdsBusinessEnquiryHistory :  IEquatable<XdsBusinessEnquiryHistory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XdsBusinessEnquiryHistory" /> class.
        /// </summary>
        ...
        public XdsBusinessEnquiryHistory(string displayText = default(string), string enquiryDate = default(string), string subscriberName = default(string), string subscriberBusinessTypeDesc = default(string), string subscriberContact = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XdsBusinessEnquiryHistory {\n");
        ...
        {
            return this.Equals(input as XdsBusinessEnquiryHistory);
        }

        /// <summary>
        /// Returns true if XdsBusinessEnquiryHistory instances are equal
        /// </summary>
        /// <param name="input">Instance of XdsBusinessEnquiryHistory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XdsBusinessEnquiryHistory input)
        {
            if (input == null)
                return false;
