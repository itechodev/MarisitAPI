...
{
    /// <summary>
    /// TransunionConsumer118AlertDetailQN
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118AlertDetailQN :  IEquatable<TransunionConsumer118AlertDetailQN>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118AlertDetailQN" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118AlertDetailQN {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118AlertDetailQN);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118AlertDetailQN instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118AlertDetailQN to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118AlertDetailQN input)
        {
            if (input == null)
                return false;
