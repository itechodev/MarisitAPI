...
{
    /// <summary>
    /// WindeedSpiderExclusiveUseArea
    /// </summary>
    [DataContract]
    public partial class WindeedSpiderExclusiveUseArea :  IEquatable<WindeedSpiderExclusiveUseArea>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WindeedSpiderExclusiveUseArea" /> class.
        /// </summary>
        ...
        /// <param name="schemeYear">schemeYear.</param>
        /// <param name="streetAddress">streetAddress.</param>
        /// <param name="exclusiveUseAreaNumber">exclusiveUseAreaNumber.</param>
        public WindeedSpiderExclusiveUseArea(int korbitecPropId = default(int), string localAuthority = default(string), double extent = default(double), string extentUnit = default(string), string extentText = default(string), string previousDescription = default(string), string province = default(string), string diagramDeedNumber = default(string), string registrationDivision = default(string), string lpiCode = default(string), DateTime? sellingDate = default(DateTime?), double? sellingPrice = default(double?), string sellingPriceDescription = default(string), WindeedSpiderDSCollectionOfDocument relatedDocuments = default(WindeedSpiderDSCollectionOfDocument), WindeedSpiderRegistrar? deedsOffice = default(WindeedSpiderRegistrar?), string propertyDescription = default(string), string township = default(string), int? erf = default(int?), int? portion = default(int?), string schemeName = default(string), int? schemeNumber = default(int?), int? schemeYear = default(int?), string streetAddress = default(string), string exclusiveUseAreaNumber = default(string))
        {
            ...
            this.ExclusiveUseAreaNumber = exclusiveUseAreaNumber;
        ...
        /// <summary>
        /// Gets or Sets SchemeYear
        /// </summary>
        [DataMember(Name="schemeYear", EmitDefaultValue=true)]
        ...
        /// <summary>
        /// Gets or Sets ExclusiveUseAreaNumber
        /// </summary>
        [DataMember(Name="exclusiveUseAreaNumber", EmitDefaultValue=true)]
        public string ExclusiveUseAreaNumber { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WindeedSpiderExclusiveUseArea {\n");
            ...
            sb.Append("  SchemeYear: ").Append(SchemeYear).Append("\n");
            sb.Append("  StreetAddress: ").Append(StreetAddress).Append("\n");
            sb.Append("  ExclusiveUseAreaNumber: ").Append(ExclusiveUseAreaNumber).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as WindeedSpiderExclusiveUseArea);
        }

        /// <summary>
        /// Returns true if WindeedSpiderExclusiveUseArea instances are equal
        /// </summary>
        /// <param name="input">Instance of WindeedSpiderExclusiveUseArea to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WindeedSpiderExclusiveUseArea input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SchemeYear == input.SchemeYear ||
                    (this.SchemeYear != null &&
                    this.SchemeYear.Equals(input.SchemeYear))
                ) && 
                (
                ...
                (
                    this.ExclusiveUseAreaNumber == input.ExclusiveUseAreaNumber ||
                    (this.ExclusiveUseAreaNumber != null &&
                    this.ExclusiveUseAreaNumber.Equals(input.ExclusiveUseAreaNumber))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SchemeYear != null)
                    hashCode = hashCode * 59 + this.SchemeYear.GetHashCode();
                if (this.StreetAddress != null)
                    hashCode = hashCode * 59 + this.StreetAddress.GetHashCode();
                if (this.ExclusiveUseAreaNumber != null)
                    hashCode = hashCode * 59 + this.ExclusiveUseAreaNumber.GetHashCode();
                return hashCode;
            }
        }
