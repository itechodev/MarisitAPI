...
{
    /// <summary>
    /// TransunionConsumer118EmployerDTO
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118EmployerDTO :  IEquatable<TransunionConsumer118EmployerDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118EmployerDTO" /> class.
        /// </summary>
        ...
        /// <param name="demographicDetails">demographicDetails.</param>
        public TransunionConsumer118EmployerDTO(int employerDetailsId = default(int), string companyName = default(string), string companyType = default(string), string companyRegistrationNumber = default(string), string vatRegistrationNumber = default(string), List<TransunionConsumer118DemographicsDTO> demographicDetails = default(List<TransunionConsumer118DemographicsDTO>))
        {
        ...
        /// <summary>
        /// Gets or Sets DemographicDetails
        /// </summary>
        [DataMember(Name="demographicDetails", EmitDefaultValue=true)]
        public List<TransunionConsumer118DemographicsDTO> DemographicDetails { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118EmployerDTO {\n");
            ...
            sb.Append("  DemographicDetails: ").Append(DemographicDetails).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransunionConsumer118EmployerDTO);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118EmployerDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118EmployerDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118EmployerDTO input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DemographicDetails == input.DemographicDetails ||
                    this.DemographicDetails != null &&
                    input.DemographicDetails != null &&
                    this.DemographicDetails.SequenceEqual(input.DemographicDetails)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DemographicDetails != null)
                    hashCode = hashCode * 59 + this.DemographicDetails.GetHashCode();
                return hashCode;
            }
        }
