...
{
    /// <summary>
    /// TransunionConsumer118ConsumerCountersNC50
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118ConsumerCountersNC50 :  IEquatable<TransunionConsumer118ConsumerCountersNC50>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118ConsumerCountersNC50" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118ConsumerCountersNC50 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118ConsumerCountersNC50);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118ConsumerCountersNC50 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118ConsumerCountersNC50 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118ConsumerCountersNC50 input)
        {
            if (input == null)
                return false;
