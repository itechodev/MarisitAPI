...
{
    /// <summary>
    /// TransunionCommercialPrincipalDetailEmpirica
    /// </summary>
    [DataContract]
    public partial class TransunionCommercialPrincipalDetailEmpirica :  IEquatable<TransunionCommercialPrincipalDetailEmpirica>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionCommercialPrincipalDetailEmpirica" /> class.
        /// </summary>
        ...
        public TransunionCommercialPrincipalDetailEmpirica(string majorProduct = default(string), string surname = default(string), string forename1 = default(string), string forename2 = default(string), string forename3 = default(string), string idNumber = default(string), string dateOfBirth = default(string), string comment = default(string), string civilCourtRecord = default(string), string defaultData = default(string), string noticesOrNotarialBonds = default(string), string confirmedByRegistrar = default(string), string position = default(string), string dateStarted = default(string), string dateDisputed = default(string), string debtCouncilDate = default(string), string debtCouncilDesc = default(string), string deeds = default(string), string infoDate = default(string), string assetNotarialBond = default(string), string empiricaScore = default(string), List<string> empiricaReasonCode = default(List<string>), List<string> empiricaReasonDescription = default(List<string>), string empiricaExclusionCode = default(string), string empiricaExclusionDescription = default(string), string expansionCode = default(string), string expansionCodeDescription = default(string), string empiricaVersion = default(string))
        {
            ...
            this.ExpansionCodeDescription = expansionCodeDescription;
            this.EmpiricaVersion = empiricaVersion;
            this.MajorProduct = majorProduct;
            this.Surname = surname;
            this.Forename1 = forename1;
            this.Forename2 = forename2;
        ...
        /// <summary>
        /// Gets or Sets ExpansionCodeDescription
        /// </summary>
        [DataMember(Name="expansionCodeDescription", EmitDefaultValue=true)]
        public string ExpansionCodeDescription { get; set; }

        /// <summary>
        /// Gets or Sets EmpiricaVersion
        /// </summary>
        [DataMember(Name="empiricaVersion", EmitDefaultValue=true)]
        public string EmpiricaVersion { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionCommercialPrincipalDetailEmpirica {\n");
            ...
            sb.Append("  ExpansionCodeDescription: ").Append(ExpansionCodeDescription).Append("\n");
            sb.Append("  EmpiricaVersion: ").Append(EmpiricaVersion).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransunionCommercialPrincipalDetailEmpirica);
        }

        /// <summary>
        /// Returns true if TransunionCommercialPrincipalDetailEmpirica instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionCommercialPrincipalDetailEmpirica to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionCommercialPrincipalDetailEmpirica input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ExpansionCodeDescription == input.ExpansionCodeDescription ||
                    (this.ExpansionCodeDescription != null &&
                    this.ExpansionCodeDescription.Equals(input.ExpansionCodeDescription))
                ) && 
                (
                    this.EmpiricaVersion == input.EmpiricaVersion ||
                    (this.EmpiricaVersion != null &&
                    this.EmpiricaVersion.Equals(input.EmpiricaVersion))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ExpansionCodeDescription != null)
                    hashCode = hashCode * 59 + this.ExpansionCodeDescription.GetHashCode();
                if (this.EmpiricaVersion != null)
                    hashCode = hashCode * 59 + this.EmpiricaVersion.GetHashCode();
                return hashCode;
            }
        }
