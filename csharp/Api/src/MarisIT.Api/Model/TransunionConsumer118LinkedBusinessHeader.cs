...
{
    /// <summary>
    /// TransunionConsumer118LinkedBusinessHeader
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118LinkedBusinessHeader :  IEquatable<TransunionConsumer118LinkedBusinessHeader>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118LinkedBusinessHeader" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118LinkedBusinessHeader {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118LinkedBusinessHeader);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118LinkedBusinessHeader instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118LinkedBusinessHeader to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118LinkedBusinessHeader input)
        {
            if (input == null)
                return false;
