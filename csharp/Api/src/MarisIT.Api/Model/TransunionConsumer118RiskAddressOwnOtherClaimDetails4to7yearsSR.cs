...
{
    /// <summary>
    /// TransunionConsumer118RiskAddressOwnOtherClaimDetails4to7yearsSR
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118RiskAddressOwnOtherClaimDetails4to7yearsSR :  IEquatable<TransunionConsumer118RiskAddressOwnOtherClaimDetails4to7yearsSR>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118RiskAddressOwnOtherClaimDetails4to7yearsSR" /> class.
        /// </summary>
        ...
        public TransunionConsumer118RiskAddressOwnOtherClaimDetails4to7yearsSR(string claimIndicator = default(string), string requestIndicator = default(string), string insurerName = default(string), string policyNo = default(string), string dateofLoss = default(string), string claimNumber = default(string), string claimStatus = default(string), string claimStatusDate = default(string), string repudiationReason = default(string), string claimClass1 = default(string), string causeofLoss1 = default(string), string initialAmount1 = default(string), string finalAmount1 = default(string), string claimClass2 = default(string), string causeofLoss2 = default(string), string initialAmount2 = default(string), string finalAmount2 = default(string), string claimClass3 = default(string), string causeofLoss3 = default(string), string initialAmount3 = default(string), string finalAmount3 = default(string), List<TransunionConsumer118ElectronicDeviceSerialNumbers> electronicDeviceSerialNumbers = default(List<TransunionConsumer118ElectronicDeviceSerialNumbers>))
        {
            ...
            this.ElectronicDeviceSerialNumbers = electronicDeviceSerialNumbers;
            this.ClaimIndicator = claimIndicator;
            this.RequestIndicator = requestIndicator;
            this.InsurerName = insurerName;
            this.PolicyNo = policyNo;
        ...
        /// <summary>
        /// Gets or Sets ElectronicDeviceSerialNumbers
        /// </summary>
        [DataMember(Name="electronicDeviceSerialNumbers", EmitDefaultValue=true)]
        public List<TransunionConsumer118ElectronicDeviceSerialNumbers> ElectronicDeviceSerialNumbers { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118RiskAddressOwnOtherClaimDetails4to7yearsSR {\n");
            ...
            sb.Append("  ElectronicDeviceSerialNumbers: ").Append(ElectronicDeviceSerialNumbers).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransunionConsumer118RiskAddressOwnOtherClaimDetails4to7yearsSR);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118RiskAddressOwnOtherClaimDetails4to7yearsSR instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118RiskAddressOwnOtherClaimDetails4to7yearsSR to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118RiskAddressOwnOtherClaimDetails4to7yearsSR input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ElectronicDeviceSerialNumbers == input.ElectronicDeviceSerialNumbers ||
                    this.ElectronicDeviceSerialNumbers != null &&
                    input.ElectronicDeviceSerialNumbers != null &&
                    this.ElectronicDeviceSerialNumbers.SequenceEqual(input.ElectronicDeviceSerialNumbers)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ElectronicDeviceSerialNumbers != null)
                    hashCode = hashCode * 59 + this.ElectronicDeviceSerialNumbers.GetHashCode();
                return hashCode;
            }
        }
