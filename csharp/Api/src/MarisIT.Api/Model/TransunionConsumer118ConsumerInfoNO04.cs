...
{
    /// <summary>
    /// TransunionConsumer118ConsumerInfoNO04
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118ConsumerInfoNO04 :  IEquatable<TransunionConsumer118ConsumerInfoNO04>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118ConsumerInfoNO04" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118ConsumerInfoNO04 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118ConsumerInfoNO04);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118ConsumerInfoNO04 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118ConsumerInfoNO04 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118ConsumerInfoNO04 input)
        {
            if (input == null)
                return false;
