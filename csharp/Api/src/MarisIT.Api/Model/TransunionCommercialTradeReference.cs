...
{
    /// <summary>
    /// TransunionCommercialTradeReference
    /// </summary>
    [DataContract]
    public partial class TransunionCommercialTradeReference :  IEquatable<TransunionCommercialTradeReference>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionCommercialTradeReference" /> class.
        /// </summary>
        ...
        /// <param name="tradeAccountNumber">tradeAccountNumber.</param>
        public TransunionCommercialTradeReference(string majorProduct = default(string), string dateOfRef = default(string), string yearsKnown = default(string), string monthsKnown = default(string), string creditLimit = default(string), string unlimited = default(string), string purchases = default(string), string termsTaken = default(string), string termsGiven = default(string), string discount = default(string), string referenceName = default(string), string insurance = default(string), string insuranceDesc = default(string), string comment = default(string), string obtained = default(string), string tradeAccountNumber = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets TradeAccountNumber
        /// </summary>
        [DataMember(Name="tradeAccountNumber", EmitDefaultValue=true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionCommercialTradeReference {\n");
            ...
            sb.Append("  TradeAccountNumber: ").Append(TradeAccountNumber).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransunionCommercialTradeReference);
        }

        /// <summary>
        /// Returns true if TransunionCommercialTradeReference instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionCommercialTradeReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionCommercialTradeReference input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TradeAccountNumber == input.TradeAccountNumber ||
                    (this.TradeAccountNumber != null &&
                    this.TradeAccountNumber.Equals(input.TradeAccountNumber))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TradeAccountNumber != null)
                    hashCode = hashCode * 59 + this.TradeAccountNumber.GetHashCode();
                return hashCode;
            }
        }
