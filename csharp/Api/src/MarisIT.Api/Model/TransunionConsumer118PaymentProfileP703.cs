...
{
    /// <summary>
    /// TransunionConsumer118PaymentProfileP703
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118PaymentProfileP703 :  IEquatable<TransunionConsumer118PaymentProfileP703>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118PaymentProfileP703" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118PaymentProfileP703 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118PaymentProfileP703);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118PaymentProfileP703 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118PaymentProfileP703 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118PaymentProfileP703 input)
        {
            if (input == null)
                return false;
