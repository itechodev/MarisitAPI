...
{
    /// <summary>
    /// XdsConsumerAddressHistory
    /// </summary>
    [DataContract]
    public partial class XdsConsumerAddressHistory :  IEquatable<XdsConsumerAddressHistory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XdsConsumerAddressHistory" /> class.
        /// </summary>
        ...
        public XdsConsumerAddressHistory(string address = default(string), string address1 = default(string), string address2 = default(string), string address3 = default(string), string address4 = default(string), string addressID = default(string), string addressType = default(string), string addressTypeInd = default(string), string consumerAddressID = default(string), string date = default(string), string displayText = default(string), string firstReportedDate = default(string), string lastUpdatedDate = default(string), string lines = default(string), string postalCode = default(string), string type = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XdsConsumerAddressHistory {\n");
        ...
        {
            return this.Equals(input as XdsConsumerAddressHistory);
        }

        /// <summary>
        /// Returns true if XdsConsumerAddressHistory instances are equal
        /// </summary>
        /// <param name="input">Instance of XdsConsumerAddressHistory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XdsConsumerAddressHistory input)
        {
            if (input == null)
                return false;
