...
{
    /// <summary>
    /// XdsDirectorPropertyInterests
    /// </summary>
    [DataContract]
    public partial class XdsDirectorPropertyInterests :  IEquatable<XdsDirectorPropertyInterests>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XdsDirectorPropertyInterests" /> class.
        /// </summary>
        ...
        public XdsDirectorPropertyInterests(string displayText = default(string), string directorID = default(string), string authorityName = default(string), string townshipName = default(string), string standNo = default(string), string portionNo = default(string), string titleDeedNo = default(string), string buyerName = default(string), string buyerTypeCode = default(string), string buyerIDNo = default(string), string buyerMaritalStatusCode = default(string), string sellerName = default(string), string sellerTypeCode = default(string), string sellerIDNo = default(string), string sellerMaritalStatusCode = default(string), string transferDate = default(string), string registrarName = default(string), string oldTitleDeedNo = default(string), string attorneyFirmNo = default(string), string attorneyFileNo = default(string), string titleDeedFeeAmt = default(string), string propertyTypeCode = default(string), string streetNo = default(string), string streetName = default(string), string suburbName = default(string), string cityName = default(string), string transferID = default(string), string erfNo = default(string), string deedsOffice = default(string), string physicalAddress = default(string), string propertyTypeDesc = default(string), string erfSize = default(string), string purchaseDate = default(string), string purchasePriceAmt = default(string), string buyerSharePerc = default(string), string bondHolderName = default(string), string bondAccountNo = default(string), string bondAmt = default(string), string farmName = default(string), string schemeName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XdsDirectorPropertyInterests {\n");
        ...
        {
            return this.Equals(input as XdsDirectorPropertyInterests);
        }

        /// <summary>
        /// Returns true if XdsDirectorPropertyInterests instances are equal
        /// </summary>
        /// <param name="input">Instance of XdsDirectorPropertyInterests to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XdsDirectorPropertyInterests input)
        {
            if (input == null)
                return false;
