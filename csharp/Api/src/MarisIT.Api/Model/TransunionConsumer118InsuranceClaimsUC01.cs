...
{
    /// <summary>
    /// TransunionConsumer118InsuranceClaimsUC01
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118InsuranceClaimsUC01 :  IEquatable<TransunionConsumer118InsuranceClaimsUC01>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118InsuranceClaimsUC01" /> class.
        /// </summary>
        ...
        public TransunionConsumer118InsuranceClaimsUC01(string consumerRole = default(string), string insuranceCompanyName = default(string), string insuranceCompanyClaimNumber = default(string), string brokerName = default(string), string brokerClaimNumber = default(string), string estimatedCost = default(string), string grossSettlement = default(string), string nettSettlement = default(string), string dateOfLoss = default(string), string claimStatus = default(string), string claimClass = default(string), string causeOfLoss = default(string), string repudiationReason = default(string), string itemInceptionDate = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118InsuranceClaimsUC01 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118InsuranceClaimsUC01);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118InsuranceClaimsUC01 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118InsuranceClaimsUC01 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118InsuranceClaimsUC01 input)
        {
            if (input == null)
                return false;
