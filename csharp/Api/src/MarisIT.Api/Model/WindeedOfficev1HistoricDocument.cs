...
{
    /// <summary>
    /// WindeedOfficev1HistoricDocument
    /// </summary>
    [DataContract]
    public partial class WindeedOfficev1HistoricDocument :  IEquatable<WindeedOfficev1HistoricDocument>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WindeedOfficev1HistoricDocument" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WindeedOfficev1HistoricDocument {\n");
        ...
        {
            return this.Equals(input as WindeedOfficev1HistoricDocument);
        }

        /// <summary>
        /// Returns true if WindeedOfficev1HistoricDocument instances are equal
        /// </summary>
        /// <param name="input">Instance of WindeedOfficev1HistoricDocument to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WindeedOfficev1HistoricDocument input)
        {
            if (input == null)
                return false;
