...
{
    /// <summary>
    /// TransunionConsumer118AKANamesNK04
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118AKANamesNK04 :  IEquatable<TransunionConsumer118AKANamesNK04>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118AKANamesNK04" /> class.
        /// </summary>
        ...
        public TransunionConsumer118AKANamesNK04(string recordSeq = default(string), string part = default(string), string partSeq = default(string), string consumerNo = default(string), string informationDate = default(string), string akaName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118AKANamesNK04 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118AKANamesNK04);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118AKANamesNK04 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118AKANamesNK04 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118AKANamesNK04 input)
        {
            if (input == null)
                return false;
