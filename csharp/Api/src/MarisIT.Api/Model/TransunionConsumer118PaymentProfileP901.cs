...
{
    /// <summary>
    /// TransunionConsumer118PaymentProfileP901
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118PaymentProfileP901 :  IEquatable<TransunionConsumer118PaymentProfileP901>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118PaymentProfileP901" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118PaymentProfileP901 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118PaymentProfileP901);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118PaymentProfileP901 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118PaymentProfileP901 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118PaymentProfileP901 input)
        {
            if (input == null)
                return false;
