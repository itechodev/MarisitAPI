...
{
    /// <summary>
    /// TransunionConsumer118IndivualOwnOtherActivePoliciesPI
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118IndivualOwnOtherActivePoliciesPI :  IEquatable<TransunionConsumer118IndivualOwnOtherActivePoliciesPI>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118IndivualOwnOtherActivePoliciesPI" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118IndivualOwnOtherActivePoliciesPI {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118IndivualOwnOtherActivePoliciesPI);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118IndivualOwnOtherActivePoliciesPI instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118IndivualOwnOtherActivePoliciesPI to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118IndivualOwnOtherActivePoliciesPI input)
        {
            if (input == null)
                return false;
