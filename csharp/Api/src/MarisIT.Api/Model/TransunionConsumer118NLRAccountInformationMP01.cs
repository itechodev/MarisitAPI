...
{
    /// <summary>
    /// TransunionConsumer118NLRAccountInformationMP01
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118NLRAccountInformationMP01 :  IEquatable<TransunionConsumer118NLRAccountInformationMP01>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118NLRAccountInformationMP01" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118NLRAccountInformationMP01 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118NLRAccountInformationMP01);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118NLRAccountInformationMP01 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118NLRAccountInformationMP01 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118NLRAccountInformationMP01 input)
        {
            if (input == null)
                return false;
