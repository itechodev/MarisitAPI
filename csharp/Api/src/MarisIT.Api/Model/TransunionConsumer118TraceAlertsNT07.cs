...
{
    /// <summary>
    /// TransunionConsumer118TraceAlertsNT07
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118TraceAlertsNT07 :  IEquatable<TransunionConsumer118TraceAlertsNT07>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118TraceAlertsNT07" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118TraceAlertsNT07 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118TraceAlertsNT07);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118TraceAlertsNT07 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118TraceAlertsNT07 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118TraceAlertsNT07 input)
        {
            if (input == null)
                return false;
