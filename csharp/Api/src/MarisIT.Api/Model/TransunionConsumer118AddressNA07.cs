...
{
    /// <summary>
    /// TransunionConsumer118AddressNA07
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118AddressNA07 :  IEquatable<TransunionConsumer118AddressNA07>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118AddressNA07" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118AddressNA07 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118AddressNA07);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118AddressNA07 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118AddressNA07 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118AddressNA07 input)
        {
            if (input == null)
                return false;
