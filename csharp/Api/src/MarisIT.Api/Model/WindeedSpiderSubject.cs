...
{
    /// <summary>
    /// WindeedSpiderSubject
    /// </summary>
    [DataContract]
    public partial class WindeedSpiderSubject :  IEquatable<WindeedSpiderSubject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WindeedSpiderSubject" /> class.
        /// </summary>
        ...
        public WindeedSpiderSubject(string deedsOfficeName = default(string), string deedsOfficeNumber = default(string), int? uberId = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WindeedSpiderSubject {\n");
        ...
        {
            return this.Equals(input as WindeedSpiderSubject);
        }

        /// <summary>
        /// Returns true if WindeedSpiderSubject instances are equal
        /// </summary>
        /// <param name="input">Instance of WindeedSpiderSubject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WindeedSpiderSubject input)
        {
            if (input == null)
                return false;
