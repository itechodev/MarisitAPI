...
{
    /// <summary>
    /// WindeedSpiderSpiderResponse
    /// </summary>
    [DataContract]
    public partial class WindeedSpiderSpiderResponse :  IEquatable<WindeedSpiderSpiderResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WindeedSpiderSpiderResponse" /> class.
        /// </summary>
        ...
        public WindeedSpiderSpiderResponse(DateTime responseTime = default(DateTime), WindeedSpiderSubject subject = default(WindeedSpiderSubject), WindeedSpiderDSCollectionOfAssociation associations = default(WindeedSpiderDSCollectionOfAssociation), WindeedSpiderDSCollectionOfProperty currentProperties = default(WindeedSpiderDSCollectionOfProperty), WindeedSpiderDSCollectionOfProperty historicProperties = default(WindeedSpiderDSCollectionOfProperty), WindeedSpiderDSCollectionOfDocument otherDocuments = default(WindeedSpiderDSCollectionOfDocument), WindeedSpiderDSCollectionOfDocument bondDocuments = default(WindeedSpiderDSCollectionOfDocument), WindeedSpiderDSCollectionOfPossibleMatch possibleMatches = default(WindeedSpiderDSCollectionOfPossibleMatch))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WindeedSpiderSpiderResponse {\n");
        ...
        {
            return this.Equals(input as WindeedSpiderSpiderResponse);
        }

        /// <summary>
        /// Returns true if WindeedSpiderSpiderResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of WindeedSpiderSpiderResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WindeedSpiderSpiderResponse input)
        {
            if (input == null)
                return false;
