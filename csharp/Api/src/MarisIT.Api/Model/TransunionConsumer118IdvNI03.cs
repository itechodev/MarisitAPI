...
{
    /// <summary>
    /// TransunionConsumer118IdvNI03
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118IdvNI03 :  IEquatable<TransunionConsumer118IdvNI03>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118IdvNI03" /> class.
        /// </summary>
        ...
        /// <param name="idVerifiedIndicator">idVerifiedIndicator.</param>
        public TransunionConsumer118IdvNI03(string idVerifiedCode = default(string), string idVerifiedDesc = default(string), string idWarning = default(string), string idDesc = default(string), string verifiedSurname = default(string), string verifiedForename1 = default(string), string verifiedForename2 = default(string), string deceasedDate = default(string), string idVerifiedIndicator = default(string))
        {
            ...
            this.IdVerifiedIndicator = idVerifiedIndicator;
            this.IdVerifiedCode = idVerifiedCode;
            this.IdVerifiedDesc = idVerifiedDesc;
            this.IdWarning = idWarning;
            this.IdDesc = idDesc;
        ...
        /// <summary>
        /// Gets or Sets IdVerifiedIndicator
        /// </summary>
        [DataMember(Name="idVerifiedIndicator", EmitDefaultValue=true)]
        public string IdVerifiedIndicator { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118IdvNI03 {\n");
            ...
            sb.Append("  IdVerifiedIndicator: ").Append(IdVerifiedIndicator).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransunionConsumer118IdvNI03);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118IdvNI03 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118IdvNI03 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118IdvNI03 input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.IdVerifiedIndicator == input.IdVerifiedIndicator ||
                    (this.IdVerifiedIndicator != null &&
                    this.IdVerifiedIndicator.Equals(input.IdVerifiedIndicator))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IdVerifiedIndicator != null)
                    hashCode = hashCode * 59 + this.IdVerifiedIndicator.GetHashCode();
                return hashCode;
            }
        }
