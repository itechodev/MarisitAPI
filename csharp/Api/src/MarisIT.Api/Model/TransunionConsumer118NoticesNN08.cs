...
{
    /// <summary>
    /// TransunionConsumer118NoticesNN08
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118NoticesNN08 :  IEquatable<TransunionConsumer118NoticesNN08>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118NoticesNN08" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118NoticesNN08 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118NoticesNN08);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118NoticesNN08 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118NoticesNN08 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118NoticesNN08 input)
        {
            if (input == null)
                return false;
