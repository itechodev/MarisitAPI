...
namespace MarisIT.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WindeedSpiderFarm :  IEquatable<WindeedSpiderFarm>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WindeedSpiderFarm" /> class.
        /// </summary>
        ...
        public WindeedSpiderFarm(int korbitecPropId = default(int), string localAuthority = default(string), double extent = default(double), string extentUnit = default(string), string extentText = default(string), string previousDescription = default(string), string province = default(string), string diagramDeedNumber = default(string), string registrationDivision = default(string), string lpiCode = default(string), DateTime? sellingDate = default(DateTime?), double? sellingPrice = default(double?), string sellingPriceDescription = default(string), WindeedSpiderDSCollectionOfDocument relatedDocuments = default(WindeedSpiderDSCollectionOfDocument), WindeedSpiderRegistrar? deedsOffice = default(WindeedSpiderRegistrar?), string propertyDescription = default(string), string farmName = default(string), int? farmNumber = default(int?), string portionNumber = default(string), string streetAddress = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WindeedSpiderFarm {\n");
        ...
        {
            return this.Equals(input as WindeedSpiderFarm);
        }

        /// <summary>
        /// Returns true if WindeedSpiderFarm instances are equal
        /// </summary>
        /// <param name="input">Instance of WindeedSpiderFarm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WindeedSpiderFarm input)
        {
            if (input == null)
                return false;
