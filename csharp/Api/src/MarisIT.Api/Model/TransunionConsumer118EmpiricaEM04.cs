...
{
    /// <summary>
    /// TransunionConsumer118EmpiricaEM04
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118EmpiricaEM04 :  IEquatable<TransunionConsumer118EmpiricaEM04>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118EmpiricaEM04" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118EmpiricaEM04 {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118EmpiricaEM04);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118EmpiricaEM04 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118EmpiricaEM04 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118EmpiricaEM04 input)
        {
            if (input == null)
                return false;
