...
{
    /// <summary>
    /// XdsConsumerEnquiryHistory
    /// </summary>
    [DataContract]
    public partial class XdsConsumerEnquiryHistory :  IEquatable<XdsConsumerEnquiryHistory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="XdsConsumerEnquiryHistory" /> class.
        /// </summary>
        /// <param name="creditGrantorEnquiryReasonDesc">creditGrantorEnquiryReasonDesc.</param>
        ...
        public XdsConsumerEnquiryHistory(string creditGrantorEnquiryReasonDesc = default(string), string displayText = default(string), string enquiryDate = default(string), string subscriberBusinessTypeDesc = default(string), string subscriberContact = default(string), string subscriberName = default(string))
        {
            this.CreditGrantorEnquiryReasonDesc = creditGrantorEnquiryReasonDesc;
        ...
        /// <summary>
        /// Gets or Sets CreditGrantorEnquiryReasonDesc
        /// </summary>
        [DataMember(Name="creditGrantorEnquiryReasonDesc", EmitDefaultValue=true)]
        public string CreditGrantorEnquiryReasonDesc { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class XdsConsumerEnquiryHistory {\n");
            sb.Append("  CreditGrantorEnquiryReasonDesc: ").Append(CreditGrantorEnquiryReasonDesc).Append("\n");
        ...
        {
            return this.Equals(input as XdsConsumerEnquiryHistory);
        }

        /// <summary>
        /// Returns true if XdsConsumerEnquiryHistory instances are equal
        /// </summary>
        /// <param name="input">Instance of XdsConsumerEnquiryHistory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(XdsConsumerEnquiryHistory input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CreditGrantorEnquiryReasonDesc == input.CreditGrantorEnquiryReasonDesc ||
                    (this.CreditGrantorEnquiryReasonDesc != null &&
                    this.CreditGrantorEnquiryReasonDesc.Equals(input.CreditGrantorEnquiryReasonDesc))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.CreditGrantorEnquiryReasonDesc != null)
                    hashCode = hashCode * 59 + this.CreditGrantorEnquiryReasonDesc.GetHashCode();
