...
namespace MarisIT.Api.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WindeedLightstoneProxiesLightstoneValuationShortResponseFlatten :  IEquatable<WindeedLightstoneProxiesLightstoneValuationShortResponseFlatten>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WindeedLightstoneProxiesLightstoneValuationShortResponseFlatten" /> class.
        /// </summary>
        /// <param name="property">property.</param>
        /// <param name="municipalValuation">municipalValuation.</param>
        /// <param name="lastSale">lastSale.</param>
        public WindeedLightstoneProxiesLightstoneValuationShortResponseFlatten(WindeedLightstoneProxiesFarmOrFreeholdOrUnit property = default(WindeedLightstoneProxiesFarmOrFreeholdOrUnit), WindeedLightstoneMunicipalValuation municipalValuation = default(WindeedLightstoneMunicipalValuation), WindeedLightstoneLastSale lastSale = default(WindeedLightstoneLastSale))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WindeedLightstoneProxiesLightstoneValuationShortResponseFlatten {\n");
        ...
        {
            return this.Equals(input as WindeedLightstoneProxiesLightstoneValuationShortResponseFlatten);
        }

        /// <summary>
        /// Returns true if WindeedLightstoneProxiesLightstoneValuationShortResponseFlatten instances are equal
        /// </summary>
        /// <param name="input">Instance of WindeedLightstoneProxiesLightstoneValuationShortResponseFlatten to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WindeedLightstoneProxiesLightstoneValuationShortResponseFlatten input)
        {
            if (input == null)
                return false;
