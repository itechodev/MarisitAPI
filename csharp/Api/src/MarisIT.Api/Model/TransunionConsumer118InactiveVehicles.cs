...
{
    /// <summary>
    /// TransunionConsumer118InactiveVehicles
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118InactiveVehicles :  IEquatable<TransunionConsumer118InactiveVehicles>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118InactiveVehicles" /> class.
        /// </summary>
        ...
        public TransunionConsumer118InactiveVehicles(string effectiveDate = default(string), string vehicleCancellationDate = default(string), string vehicleRiskType = default(string), string coverType = default(string), string viNChassisNumber = default(string), string engineNumber = default(string), string registrationNumber = default(string), string yearofRegistration = default(string), string make = default(string), string model = default(string), string colour = default(string), string driverSameAsPolicyHolder = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118InactiveVehicles {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118InactiveVehicles);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118InactiveVehicles instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118InactiveVehicles to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118InactiveVehicles input)
        {
            if (input == null)
                return false;
