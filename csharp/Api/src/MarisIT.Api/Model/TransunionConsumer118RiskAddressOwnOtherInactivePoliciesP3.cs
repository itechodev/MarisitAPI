...
{
    /// <summary>
    /// TransunionConsumer118RiskAddressOwnOtherInactivePoliciesP3
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118RiskAddressOwnOtherInactivePoliciesP3 :  IEquatable<TransunionConsumer118RiskAddressOwnOtherInactivePoliciesP3>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118RiskAddressOwnOtherInactivePoliciesP3" /> class.
        /// </summary>
        ...
        /// <param name="inactiveRiskAddresses">inactiveRiskAddresses.</param>
        public TransunionConsumer118RiskAddressOwnOtherInactivePoliciesP3(string requestIndicator = default(string), string ownOtherActivePolicyIndicator = default(string), string insurerName = default(string), string policyNumber = default(string), List<string> riskType = default(List<string>), string policyStatus = default(string), string policyInceptionDate = default(string), string policyCancellationDate = default(string), List<TransunionConsumer118InactiveRiskAddresses> inactiveRiskAddresses = default(List<TransunionConsumer118InactiveRiskAddresses>))
        {
            ...
            this.InactiveRiskAddresses = inactiveRiskAddresses;
            this.RequestIndicator = requestIndicator;
            this.OwnOtherActivePolicyIndicator = ownOtherActivePolicyIndicator;
            this.InsurerName = insurerName;
            this.PolicyNumber = policyNumber;
        ...
        /// <summary>
        /// Gets or Sets InactiveRiskAddresses
        /// </summary>
        [DataMember(Name="inactiveRiskAddresses", EmitDefaultValue=true)]
        public List<TransunionConsumer118InactiveRiskAddresses> InactiveRiskAddresses { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118RiskAddressOwnOtherInactivePoliciesP3 {\n");
            ...
            sb.Append("  InactiveRiskAddresses: ").Append(InactiveRiskAddresses).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TransunionConsumer118RiskAddressOwnOtherInactivePoliciesP3);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118RiskAddressOwnOtherInactivePoliciesP3 instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118RiskAddressOwnOtherInactivePoliciesP3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118RiskAddressOwnOtherInactivePoliciesP3 input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.InactiveRiskAddresses == input.InactiveRiskAddresses ||
                    this.InactiveRiskAddresses != null &&
                    input.InactiveRiskAddresses != null &&
                    this.InactiveRiskAddresses.SequenceEqual(input.InactiveRiskAddresses)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InactiveRiskAddresses != null)
                    hashCode = hashCode * 59 + this.InactiveRiskAddresses.GetHashCode();
                return hashCode;
            }
        }
