...
{
    /// <summary>
    /// TransunionCommercialBusinessDeedsSummaryDA
    /// </summary>
    [DataContract]
    public partial class TransunionCommercialBusinessDeedsSummaryDA :  IEquatable<TransunionCommercialBusinessDeedsSummaryDA>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionCommercialBusinessDeedsSummaryDA" /> class.
        /// </summary>
        ...
        public TransunionCommercialBusinessDeedsSummaryDA(string majorProduct = default(string), string deedsOffice = default(string), string numberProperties = default(string), string totalValue = default(string), string totalBond = default(string), string totalOwned = default(string), string comment = default(string), string oldestPropertyDate = default(string), string oldestPropertyValue = default(string), string bondCount = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionCommercialBusinessDeedsSummaryDA {\n");
        ...
        {
            return this.Equals(input as TransunionCommercialBusinessDeedsSummaryDA);
        }

        /// <summary>
        /// Returns true if TransunionCommercialBusinessDeedsSummaryDA instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionCommercialBusinessDeedsSummaryDA to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionCommercialBusinessDeedsSummaryDA input)
        {
            if (input == null)
                return false;
