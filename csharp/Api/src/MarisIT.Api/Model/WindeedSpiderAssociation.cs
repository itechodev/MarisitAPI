...
{
    /// <summary>
    /// WindeedSpiderAssociation
    /// </summary>
    [DataContract]
    public partial class WindeedSpiderAssociation :  IEquatable<WindeedSpiderAssociation>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WindeedSpiderAssociation" /> class.
        /// </summary>
        ...
        public WindeedSpiderAssociation(int dbKey = default(int), string deedsOfficeName = default(string), string deedsOfficeNumber = default(string), int currentPropertyCount = default(int), int historicPropertyCount = default(int), WindeedSpiderPersonType? subjectType = default(WindeedSpiderPersonType?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WindeedSpiderAssociation {\n");
        ...
        {
            return this.Equals(input as WindeedSpiderAssociation);
        }

        /// <summary>
        /// Returns true if WindeedSpiderAssociation instances are equal
        /// </summary>
        /// <param name="input">Instance of WindeedSpiderAssociation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WindeedSpiderAssociation input)
        {
            if (input == null)
                return false;
