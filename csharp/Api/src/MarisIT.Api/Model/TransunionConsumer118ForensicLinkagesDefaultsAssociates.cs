...
{
    /// <summary>
    /// TransunionConsumer118ForensicLinkagesDefaultsAssociates
    /// </summary>
    [DataContract]
    public partial class TransunionConsumer118ForensicLinkagesDefaultsAssociates :  IEquatable<TransunionConsumer118ForensicLinkagesDefaultsAssociates>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransunionConsumer118ForensicLinkagesDefaultsAssociates" /> class.
        /// </summary>
        ...
        public TransunionConsumer118ForensicLinkagesDefaultsAssociates(string consumerNumber = default(string), string surname = default(string), string forename1 = default(string), string identityNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransunionConsumer118ForensicLinkagesDefaultsAssociates {\n");
        ...
        {
            return this.Equals(input as TransunionConsumer118ForensicLinkagesDefaultsAssociates);
        }

        /// <summary>
        /// Returns true if TransunionConsumer118ForensicLinkagesDefaultsAssociates instances are equal
        /// </summary>
        /// <param name="input">Instance of TransunionConsumer118ForensicLinkagesDefaultsAssociates to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransunionConsumer118ForensicLinkagesDefaultsAssociates input)
        {
            if (input == null)
                return false;
